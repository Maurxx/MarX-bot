...
module.exports = {
    name: "resume",
    description: "Despausa la canción.",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (player.playing) return client.sendTime(interaction, "❌ | **La canción ya se ha despausado!**");
        player.pause(false);
        await message.react("✅");
    },
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (player.playing) return client.sendTime(interaction, "❌ | **La canción ya se despausó!**");
            player.pause(false);
            client.sendTime(interaction, "**⏯ Se despausó la canción!**");
        },
    },
};
