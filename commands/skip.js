...
module.exports = {
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (skipTo !== null && (isNaN(skipTo) || skipTo < 1 || skipTo > player.queue.length)) return client.sendTime(interaction, "❌ | **Número inválido para saltar!**");
            player.stop(skipTo);
            client.sendTime(interaction, "**Saltada!**");
        },
    },
};
